...
let topSymbolImg = "./img/July4th/topSymbol.png";
let premiumGoldImg = "./img/July4th/premiumGold.png";
let premiumSilverImg = "./img/July4th/premiumSilver.png";
let premiumCopperImg = "./img/July4th/premiumCopper.png";
let goldImg = "./img/July4th/gold.png";
let silverImg = "./img/July4th/silver.png";
let copperImg = "./img/July4th/copper.png";
let bonusImg = "./img/chest-closed.png";
let bonusImg2 = "./img/chest-open.png";

const symbolValuesBig = {
    "./img/July4th/topSymbol.png": 40,
    "./img/July4th/premiumGold.png": 35,
    "./img/July4th/premiumSilver.png": 30,
    "./img/July4th/premiumCopper.png": 25,
    "./img/July4th/gold.png": 20,
    "./img/July4th/silver.png": 15,
    "./img/July4th/copper.png": 14,
    "./img/chest-closed.png": "Bonus",
};

const symbolValuesSmall = {
    "./img/July4th/topSymbol.png": 20,
    "./img/July4th/premiumGold.png": 15,
    "./img/July4th/premiumSilver.png": 10,
    "./img/July4th/premiumCopper.png": 7,
    "./img/July4th/gold.png": 5,
    "./img/July4th/silver.png": 4,
    "./img/July4th/copper.png": 2,
    "./img/chest-closed.png": "Bonus",
};
...
const symbolWinChanceBig = {
    "./img/July4th/topSymbol.png": evenChance,
    "./img/July4th/premiumGold.png": evenChance,
    "./img/July4th/premiumSilver.png": evenChance,
    "./img/July4th/premiumCopper.png": evenChance,
    "./img/July4th/gold.png": evenChance,
    "./img/July4th/silver.png": evenChance,
    "./img/July4th/copper.png": evenChance,
