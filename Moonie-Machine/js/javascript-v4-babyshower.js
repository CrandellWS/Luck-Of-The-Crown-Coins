...
let topSymbolImg = "./img/babyshower/topSymbol.png";
let premiumGoldImg = "./img/babyshower/premiumGold.png";
let premiumSilverImg = "./img/babyshower/premiumSilver.png";
let premiumCopperImg = "./img/babyshower/premiumCopper.png";
let goldImg = "./img/babyshower/gold.png";
let silverImg = "./img/babyshower/silver.png";
let copperImg = "./img/babyshower/copper.png";
let bonusImg = "./img/chest-closed.png";
let bonusImg2 = "./img/chest-open.png";

const symbolValuesBig = {
    "./img/babyshower/topSymbol.png": 40,
    "./img/babyshower/premiumGold.png": 35,
    "./img/babyshower/premiumSilver.png": 30,
    "./img/babyshower/premiumCopper.png": 25,
    "./img/babyshower/gold.png": 20,
    "./img/babyshower/silver.png": 15,
    "./img/babyshower/copper.png": 14,
    "./img/chest-closed.png": "Bonus",
};

const symbolValuesSmall = {
    "./img/babyshower/topSymbol.png": 20,
    "./img/babyshower/premiumGold.png": 15,
    "./img/babyshower/premiumSilver.png": 10,
    "./img/babyshower/premiumCopper.png": 7,
    "./img/babyshower/gold.png": 5,
    "./img/babyshower/silver.png": 4,
    "./img/babyshower/copper.png": 2,
    "./img/chest-closed.png": "Bonus",
};
...
const symbolWinChanceBig = {
    "./img/babyshower/topSymbol.png": evenChance,
    "./img/babyshower/premiumGold.png": evenChance,
    "./img/babyshower/premiumSilver.png": evenChance,
    "./img/babyshower/premiumCopper.png": evenChance,
    "./img/babyshower/gold.png": evenChance,
    "./img/babyshower/silver.png": evenChance,
    "./img/babyshower/copper.png": evenChance,
