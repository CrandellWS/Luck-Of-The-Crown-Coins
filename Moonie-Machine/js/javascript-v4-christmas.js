...
let topSymbolImg = "./img/christmas/topSymbol.png";
let premiumGoldImg = "./img/christmas/premiumGold.png";
let premiumSilverImg = "./img/christmas/premiumSilver.png";
let premiumCopperImg = "./img/christmas/premiumCopper.png";
let goldImg = "./img/christmas/gold.png";
let silverImg = "./img/christmas/silver.png";
let copperImg = "./img/christmas/copper.png";
let bonusImg = "./img/chest-closed.png";
let bonusImg2 = "./img/chest-open.png";

const symbolValuesBig = {
    "./img/christmas/topSymbol.png": 40,
    "./img/christmas/premiumGold.png": 35,
    "./img/christmas/premiumSilver.png": 30,
    "./img/christmas/premiumCopper.png": 25,
    "./img/christmas/gold.png": 20,
    "./img/christmas/silver.png": 15,
    "./img/christmas/copper.png": 14,
    "./img/chest-closed.png": "Bonus",
};

const symbolValuesSmall = {
    "./img/christmas/topSymbol.png": 20,
    "./img/christmas/premiumGold.png": 15,
    "./img/christmas/premiumSilver.png": 10,
    "./img/christmas/premiumCopper.png": 7,
    "./img/christmas/gold.png": 5,
    "./img/christmas/silver.png": 4,
    "./img/christmas/copper.png": 2,
    "./img/chest-closed.png": "Bonus",
};
...
const symbolWinChanceBig = {
    "./img/christmas/topSymbol.png": evenChance,
    "./img/christmas/premiumGold.png": evenChance,
    "./img/christmas/premiumSilver.png": evenChance,
    "./img/christmas/premiumCopper.png": evenChance,
    "./img/christmas/gold.png": evenChance,
    "./img/christmas/silver.png": evenChance,
    "./img/christmas/copper.png": evenChance,
    ...
    spinButton.addEventListener('click', () => {
        ...
        setTimeout(() => {
            ...
            if (winningSymbol) {
                ...
                // Find matching value item (even if it uses sprite instead of <img>)
                const winningItem = document.querySelector(
                    `.symbol-value-item [style*="${winningSymbol}"]`
                )?.parentElement;
                ...
                const scVal = symbolValuesToUse[winningSymbol]; // Use correct symbol values (big or small)

                // Create text above the symbol
                const overlayText = document.createElement('h1');
                overlayText.innerHTML = 'Win With Ash! <br> ' + scVal + ' SC';
                overlayText.className = 'overlay-text';
                overlay.appendChild(overlayText);

                // Create the sprite animation container
                const symbolDiv = document.createElement('div');
                symbolDiv.className = 'symbol animate play';
                symbolDiv.style.backgroundImage = `url(${winningSymbol})`;
                symbolDiv.style.backgroundSize = '400% 400%';
                symbolDiv.style.backgroundRepeat = 'no-repeat';
                symbolDiv.style.backgroundPosition = '0% 0%';
                symbolDiv.style.width = '50vh';
                symbolDiv.style.height = '50vh';
                symbolDiv.style.paddingTop = '0';
                overlay.appendChild(symbolDiv);

                // Add overlay to the document
                document.body.appendChild(overlay);

                // Animate the symbol growth (zoom-in effect)
                setTimeout(() => {
...
function generateInitialSymbols(reel, numSymbols = 21) {
    ...
    const symbolKeys = Object.keys(symbolValuesToUse).filter(
        symbol => symbolWinChancesToUse[symbol] > 0
    );

    const symbolsContainer = reel.querySelector('.symbols');
    symbolsContainer.innerHTML = ''; // Clear existing
    ...
    for (let i = 0; i < numSymbols; i++) {
        ...
        newSymbol.style.backgroundImage = `url(${randomKey})`; // use existing URL
        newSymbol.dataset.symbolKey = randomKey; // optional, for debugging or later use
...
function spinReel(reel, duration, winningSymbol) {
    ...
    for (let i = 0; i < 3; i++) {
        ...
        const randomKey = validSymbols[Math.floor(Math.random() * validSymbols.length)];
        newSymbol.style.backgroundImage = `url(${randomKey})`;
    ...
    // Replace img.src logic in winning symbol section
...
function renderSymbolValues() {
    ...
    symbolKeys.forEach((symbolSrc) => {
        ...
        // Instead of using <img>, show first frame of sprite sheet
        frame.style.backgroundImage = `url(${symbolSrc})`;
        frame.style.backgroundRepeat = 'no-repeat';
        frame.style.backgroundSize = '400% 400%'; // 4x4 grid
        frame.style.backgroundPosition = '0% 0%'; // first frame
        frame.style.imageRendering = 'pixelated';
        frame.style.width = '100%';
        frame.style.height = '60px';
        frame.style.maxWidth = '60px';
        frame.style.maxHeight = '60px';
