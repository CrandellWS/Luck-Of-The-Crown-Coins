...
let topSymbolImg = "./img/halloween/topSymbol.png";
let premiumGoldImg = "./img/halloween/premiumGold.png";
let premiumSilverImg = "./img/halloween/premiumSilver.png";
let premiumCopperImg = "./img/halloween/premiumCopper.png";
let goldImg = "./img/halloween/gold.png";
let silverImg = "./img/halloween/silver.png";
let copperImg = "./img/halloween/copper.png";
let bonusImg = "./img/chest-closed.png";
let bonusImg2 = "./img/chest-open.png";

const symbolValuesBig = {
    "./img/halloween/topSymbol.png": 40,
    "./img/halloween/premiumGold.png": 35,
    "./img/halloween/premiumSilver.png": 30,
    "./img/halloween/premiumCopper.png": 25,
    "./img/halloween/gold.png": 20,
    "./img/halloween/silver.png": 15,
    "./img/halloween/copper.png": 14,
    "./img/chest-closed.png": "Bonus",
};

const symbolValuesSmall = {
    "./img/halloween/topSymbol.png": 20,
    "./img/halloween/premiumGold.png": 15,
    "./img/halloween/premiumSilver.png": 10,
    "./img/halloween/premiumCopper.png": 7,
    "./img/halloween/gold.png": 5,
    "./img/halloween/silver.png": 4,
    "./img/halloween/copper.png": 2,
    "./img/chest-closed.png": "Bonus",
};
...
const symbolWinChanceBig = {
    "./img/halloween/topSymbol.png": evenChance,
    "./img/halloween/premiumGold.png": evenChance,
    "./img/halloween/premiumSilver.png": evenChance,
    "./img/halloween/premiumCopper.png": evenChance,
    "./img/halloween/gold.png": evenChance,
    "./img/halloween/silver.png": evenChance,
    "./img/halloween/copper.png": evenChance,
