...
let topSymbolImg = "./img/saintPatrick/topSymbol.png";
let premiumGoldImg = "./img/saintPatrick/premiumGold.png";
let premiumSilverImg = "./img/saintPatrick/premiumSilver.png";
let premiumCopperImg = "./img/saintPatrick/premiumCopper.png";
let goldImg = "./img/saintPatrick/gold.png";
let silverImg = "./img/saintPatrick/silver.png";
let copperImg = "./img/saintPatrick/copper.png";
let bonusImg = "./img/chest-closed.png";
let bonusImg2 = "./img/chest-open.png";

const symbolValuesBig = {
    "./img/saintPatrick/topSymbol.png": 40,
    "./img/saintPatrick/premiumGold.png": 35,
    "./img/saintPatrick/premiumSilver.png": 30,
    "./img/saintPatrick/premiumCopper.png": 25,
    "./img/saintPatrick/gold.png": 20,
    "./img/saintPatrick/silver.png": 15,
    "./img/saintPatrick/copper.png": 14,
    "./img/chest-closed.png": "Bonus",
};

const symbolValuesSmall = {
    "./img/saintPatrick/topSymbol.png": 20,
    "./img/saintPatrick/premiumGold.png": 15,
    "./img/saintPatrick/premiumSilver.png": 10,
    "./img/saintPatrick/premiumCopper.png": 7,
    "./img/saintPatrick/gold.png": 5,
    "./img/saintPatrick/silver.png": 4,
    "./img/saintPatrick/copper.png": 2,
    "./img/chest-closed.png": "Bonus",
};
...
const symbolWinChanceBig = {
    "./img/saintPatrick/topSymbol.png": evenChance,
    "./img/saintPatrick/premiumGold.png": evenChance,
    "./img/saintPatrick/premiumSilver.png": evenChance,
    "./img/saintPatrick/premiumCopper.png": evenChance,
    "./img/saintPatrick/gold.png": evenChance,
    "./img/saintPatrick/silver.png": evenChance,
    "./img/saintPatrick/copper.png": evenChance,
